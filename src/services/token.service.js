...
const generateToken = (userId, expires, type, secret = config.jwt.secret) => {
  ...
  //expires in would not work properly, check jwt docs on npm to know more, use exp instead
...
const generateAuthTokens = (user) => {
  //convert Date time in mills to Date timestamp, and then add access expiration seconds
